...
public class PDFView extends RelativeLayout {
    ...
    private boolean scaletapEnabled = true;
    ...
    public void jumpTo(int page, boolean withAnimation) {
        ...
        if (swipeVertical) {
            if (withAnimation) {
                animationManager.startYAnimation(currentYOffset, offset, duration);
            } else {
                moveTo(currentXOffset, offset);
            }
        } else {
            if (withAnimation) {
                animationManager.startXAnimation(currentXOffset, offset, duration);
            } else {
    ...
    void enabledScaletap(boolean enabledScaletap) {
        this.scaletapEnabled = enabledScaletap;
    }

    boolean isScaletapEnabled() {
        return scaletapEnabled;
    }
    ...
    public void zoomWithAnimation(float centerX, float centerY, float scale) {
        animationManager.startZoomAnimation(centerX, centerY, zoom, scale, duration);
    }

    public void zoomWithAnimation(float scale) {
        animationManager.startZoomAnimation((float) getWidth() / 2, (float) getHeight() / 2, zoom, scale, duration);
    }
    ...
    public class Configurator {
        ...
        private boolean enableScaletap = true;
        ...
        public Configurator enableScaletap(boolean enableScaletap) {
            this.enableScaletap = enableScaletap;
            return this;
        }
        ...
        public Configurator setDuration(long duration) {
        ...
        public void load() {
            ...
            PDFView.this.enabledScaletap(enableScaletap);
            ...
            PDFView.this.setDuration(duration);
    ...
    public void setDuration(long duration) {
        this.duration = duration;
        this.dragPinchManager.setDuration(duration);
    }
}
